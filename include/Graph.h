...
class Graph{
    private:
        ...
        std::vector<std::pair<int, std::vector<Node*>>> three_shortest_paths (Node* from, Node* to) const; /// yen or epstein 2
        std::vector<std::pair<int, std::vector<Node*>>> three_shortest_paths (std::vector<Node*> closed_locations, Node* from, Node* to)const;
    ...
    public:
        ...
        void three_shortest_paths (const std::string from, const std::string to); /// yen or epstein 2
        void three_shortest_paths (std::vector<std::string> closed_locations, const std::string from, const std::string to); /// yen or epstein 3
